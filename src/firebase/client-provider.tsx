  ...
  useEffect(() => {
    ...
    const startServices = async () => {
      ...
      const timeoutPromise = new Promise((_, reject) => 
        setTimeout(() => reject(new Error("The database connection is taking longer than expected.")), TIMEOUT_MS)
      );
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 text-center">
        ...
        <h1 className="text-xl font-bold mb-2 text-foreground">Connection Issue</h1>
